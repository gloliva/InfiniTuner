...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 245.0, 70.0, 22.0 ],
									"text" : "o.route /arg"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 213.0, 115.0, 22.0 ],
									"text" : "o.if /bypass == false"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "FullPacket", "FullPacket" ],
									"patching_rect" : [ 50.0, 132.0, 265.0, 70.0 ],
									"text" : "if (strcmp(/arg, \"#2\") == 0,\n  /bypass = true,\n  /bypass = false\n)"
								}
...
,
					"patching_rect" : [ 360.5, 106.0, 77.0, 22.0 ],
...
,
					"patching_rect" : [ 196.25, 106.0, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
